		...
		<div class="col">
			<div class="card">
				...
				<div class="card-body">
					...
					<ol>
						<li>Make payment to the account <strong>EasyPaisa 03231598062</strong> RaySD Gaming Store</li>
						<li>Include information with the order number <strong><?= $content['invoice'] ?></strong></li>
						<li>Total payment <strong>Rs. <?= number_format($content['total']) ?></strong></li>
					</ol>
